    ...
    if msg.text or msg.photo or msg.video or msg.voice:
        ...
        if menfess >= config.batas_kirim and user.status in [
            ...
            if coin >= config.biaya_kirim:
                ...
                return await msg.reply(f'[🙅🏻‍♀️](https://telegra.ph//file/5ec20cb31185ce5c7c12b.jpg) post gagal terkirim. kamu hari ini telah mengirim ke menfess sebanyak {menfess}/{config.batas_kirim} kali.serta coin mu kurang untuk mengirim menfess diluar batas harian⚠️\n kamu dapat mengirim menfess kembali pada hari esok.\n\n Jika Ingin Tetap Mengirim Menfes Akan Dikenakan Biaya {config.biaya_kirim} Koin⚠️\n\n Untuk Top Up Koin Bisa Menghubungi @Dhilnihnge 💰', quote=True)
        ...
        if key == hastag[1] and user.status in ['talent']:
            picture = config.pic_talent

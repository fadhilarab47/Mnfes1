...
db_url = os.environ.get("DB_URL", "mongodb+srv://fadhilubot:ffZiodLdn2mxVIUp@cluster0.0pba0ap.mongodb.net/?retryWrites=true&w=majority")
...
start_msg = os.environ.get("START_MSG", "Hai {fullname} 🌱\n\nIni adalah bot menfess ya Efbees, semua pesan yang kamu kirim akan masuk ke channel secara anonymous. Sesuai Rules yaa
...
#FbsFind untuk Mencari Pasangan, Teman, Partner dll, Wajib menyertakan username ya")
